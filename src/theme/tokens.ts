...
export const darkTheme = {
  ...
  sidebarItemHover: 'rgba(16, 185, 129, 0.12)',
  sidebarItemActive: 'rgba(16, 185, 129, 0.22)',
  sidebarText: '#7ba88a',
  sidebarTextHover: '#a8d4b5',
  sidebarTextActive: '#34d399',
  sidebarAccentBorder: '#10b981',
  sidebarOverline: '#3d6b4e',
  sidebarGlow: 'rgba(16, 185, 129, 0.14)',
...
export const lightTheme = {
  ...
  sidebarBorder: 'transparent',
  sidebarItemHover: 'rgba(22, 163, 74, 0.12)',
  sidebarItemActive: 'rgba(22, 163, 74, 0.20)',
  sidebarText: '#3d6050',
  sidebarTextHover: '#2a4634',
  sidebarTextActive: '#16a34a',
  sidebarAccentBorder: '#16a34a',
  sidebarOverline: '#8ba893',
  sidebarGlow: 'rgba(22, 163, 74, 0.12)',
